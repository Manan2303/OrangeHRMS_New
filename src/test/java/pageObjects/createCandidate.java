...
public class createCandidate extends basePage_HRMS {
	...
	public void cand_data_input(String f_name, String M_name, String L_name, String Email, String phn, String note_des)
	{
		// Perform in input fields
		...
		// Wait until upload indicator or notes field is ready for input
		wait.until(ExpectedConditions.elementToBeClickable(notes));
		notes.sendKeys(note_des);
		System.out.println(" Notes enter successfully................");
